...
export default function Skills() {
    return (
        <section
            id="skills"
            className="absolute top-[1817px] left-0 w-full flex justify-center"
        >
            <div className="w-[899px] h-[754px] relative">
                ...
                <div className="absolute w-[895px] h-[657px] top-[97px] left-0">
                    ...
                    <div className="absolute w-[180px] h-[180px] top-[351px] left-[350px] rounded-[90px] [background:linear-gradient(180deg,rgba(48,16,128,0.6)_0%,rgba(120,64,173,0.36)_100%)]" />
                    ...
                    <div className="absolute w-5 h-[21px] top-[438px] left-[833px] bg-[url(/group.png)] bg-[100%_100%]" />
                    <img
                    ...
                    />
                    <div className="absolute w-[11px] h-[19px] top-[578px] left-[766px] bg-[url(/group-1.png)] bg-[100%_100%]" />
                    <img
                        className="absolute w-3.5 h-[15px] top-[511px] left-[826px]"
                        alt="Group"
                        src="images/group-1900.png"
                    />
                    <img
